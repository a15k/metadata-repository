module JsonApiSchema
  ...
  class_methods do
    def json_schema(create: false)
      ...
      json_api_schema_filepath = File.join Rails.root, 'public', 'json-api.schema.json'
      ...
      json_api_schema['definitions']['resource']['properties']['id']['format'] = 'uuid'
      ...
      json_api_schema['definitions']['linkage']['properties']['id']['format'] = 'uuid'
